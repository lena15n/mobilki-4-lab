...
public class SearchActivity extends FragmentActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private AdapterView.OnItemClickListener mAutocompleteClickListener
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Log.i(MapsActivity.LOG_TAG, "Autocomplete item selected: " + primaryText);
    ...
    private static Spanned formatPlaceDetails(Resources res, CharSequence name, String id,
        ...
        Log.e(MapsActivity.LOG_TAG, res.getString(R.string.place_details, name, id, address, phoneNumber,
                websiteUri));
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        Log.e(MapsActivity.LOG_TAG, "onConnectionFailed: ConnectionResult.getErrorCode() = "
